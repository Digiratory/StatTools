...
class KasdinGenerator:
    ...
    Based on paper Kasdin, N. J. (1995). Discrete simulation of colored noise and stochastic processes and 1/f/sup α/ power law noise generation. doi:10.1109/5.381848
